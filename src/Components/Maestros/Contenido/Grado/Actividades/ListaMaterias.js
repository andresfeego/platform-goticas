            ...
            if (this.state.listaMaterias.length == 0) {
                return (
                    <div className="listaActividades">
                        <AgregarMateria idGrado={this.props.idGrado} nombreGrado={this.props.nombreGrado} fun={this} />
                        <span>No hay materias para este grado</span>
                    </div>
                )
            } else {
                return (
                    <div className="listaActividades">
                        <AgregarMateria idGrado={this.props.idGrado} nombreGrado={this.props.nombreGrado} fun={this} />
                        {this.state.listaMaterias.map((item) => <Materia key={item.id} materia={item} fun={this} idGrado={this.props.idGrado} />)}
                    </div>
                )
            }
        }
